...
{
    public class AdminUserDeletedMapperTests
    {
        private readonly AdminUserDeletedMapper _mapper;

        public AdminUserDeletedMapperTests()
        {
            _mapper = new AdminUserDeletedMapper();
        }
        ...
        public void Validate_Throws_WhenMessageIsNull()
        {
            ...
            // Assert
            Assert.Contains("[AdminUserDelete] Message is empty", ex.Errors.Select(e => e.Message));
        }
        ...
        public void Validate_Throws_WhenIdIsMissing()
        {
            ...
            // Assert
            Assert.Contains("[AdminUserDelete] ID is required", ex.Errors.Select(e => e.Message));
        }
